...
const char *vertexShaderSource[1] = {
    ...
    "   fColor = vec4(vertexColor.r, vertexColor.g, vertexColor.b, vertexColor.a);\n"
    "}\0"};

const char *fragmentShaders[1] = {
    "#version 330 core\n"
    "out vec4 FragColor;\n"
    "in vec4 fColor;\n"
    "void main()\n"
...
int main() {
  ...
  */
  ...
  Square sq1 = createSquare(vertices1, frgProgram0);
  Square sq2 = createSquare(vertices2, frgProgram0);
  Square sq3 = createSquare(vertices3, frgProgram0);
...
int initGL(GLFWwindow *&window) {
  ...
  // --------------------
  window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Magic Squares Parametrized Shaders", NULL, NULL);
